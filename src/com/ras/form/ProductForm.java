...
import com.ras.form.popup.CreateProduct;
...
public class ProductForm extends TabbedForm implements IEntityForm {
    ...
    private void cmdNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdNewActionPerformed
        ...
        // Add anti bug checkers - Pocan
            ...
            GlassPanePopup.showPopup(new SimplePopupBorder(createProduct, "Create Product", actions, (pc, i) -> {            
                if (i == 1) {
                    // save
                    try {
                        ...
                        worker = new SwingWorker<Void, Void>() {
                            ...
                            protected Void doInBackground() throws Exception {
                                ...
                                String productName = createProduct.getTxtName().getText();
                                String productDescription = createProduct.getTxtDescription().getText();
                                double productPrice = Double.valueOf(createProduct.getTxtPrice().getText());
                                Category productCategory = (Category) createProduct.getComboCategory().getSelectedItem();


                                DatabaseOperation databaseOperation = new DatabaseOperation();
                                
                                Product product = new Product(productName, productDescription, productPrice, productCategory, databaseOperation.increaseID("product"));

                                databaseOperation.addProductToDatabase(product);
                                resetData(model);
                                return null;
                            }
                            ...
                            protected void done() {
                                try {
                                    insertData("update");
                                    pc.closePopup();
                                    Notifications.getInstance().show(Notifications.Type.SUCCESS, "Product has been created");
            ...
            worker = new SwingWorker<ArrayList<Product>, Void>() {
                ...
                protected ArrayList<Product> doInBackground() throws Exception {
                    ...
                    if (type.equals("install")) {
                        Notifications.getInstance().show(Notifications.Type.INFO, "Product data loading...");
                    }
                    ...
                    for(Product p : productList) {
                        ...
                        Object[] add = {false, p.getProductID(), p.getProductName(), p.getProductDescription(), p.getProductPrice(), p.getProductCategory().categoryName()};
                        model.addRow(add);
                    }
                ...
                protected Void doInBackground() throws Exception {
                    ...
                    for(Boolean b : selectedValueList) {
                        ...
                        if (b) {
                            ...
                            databaseOperation.deleteProductFromDatabase(product);
                            counter++;
                        }   
                    }
                    resetData(model);
